...
function calculate_score($uid,$topics) {
	$len=count($topics);
	...
	$p=mysql_query(sprintf($query,$uid,implode(',',$topics)),$con); //echo sprintf($query,$uid,implode(',',$topics));
	...
	$p=mysql_query(sprintf($query,implode(',',$topics)),$con); //echo sprintf($query,implode(',',$topics));
